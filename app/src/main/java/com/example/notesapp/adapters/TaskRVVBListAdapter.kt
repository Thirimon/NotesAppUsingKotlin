...
import com.example.notesapp.databinding.ViewTaskGirdLayoutBinding
import com.example.notesapp.databinding.ViewTaskListLayoutBinding
...
class TaskRVVBListAdapter(
    ...
    class ListTaskViewHolder(private val viewTaskListLayoutBinding: ViewTaskListLayoutBinding) :
        ...
        fun bind(
            ...
            viewTaskListLayoutBinding.titleText.text = task.title
    ...
    class GridTaskViewHolder(private val viewTaskGridLayoutBinding: ViewTaskGirdLayoutBinding) :
        ...
        fun bind(
            ...
            viewTaskGridLayoutBinding.titleText.text = task.title
    ...
    override fun onCreateViewHolder(
        ...
        return if (viewType == 1){  // Grid_Item
            GridTaskViewHolder(
                ViewTaskGirdLayoutBinding.inflate(
